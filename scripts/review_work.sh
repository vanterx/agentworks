...
#
#   REVIEW_GITHUB_TOKEN=<second-identity-pat> ./review_work.sh [claude|codex|hermes] [--model <name>]
#
...
# a visible, auditable warning at every layer. See docs/AUTOMATION.md#solo-mode.
#
