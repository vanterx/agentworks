...
- `.github/trusted-reviewers.json` — put real GitHub logins in `whitelist`
  ...
  quorum — see docs/AUTOMATION.md#multi-reviewer-quorum).
...
- **Solo:** export `AW_ALLOW_SOLO_REVIEW=1` instead. Understand the
  trade-off documented in `docs/AUTOMATION.md#solo-mode` before doing
...
- Walk through `docs/SETUP.md` against `example/NOTES.md` first — it's a
